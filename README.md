...
### How to Use
1. Train the AI model using `trainthebrain.py`
2. Launch the main interface with `website.py`

All collected images will be saved and used in future model training cycles.

### Goal
To reduce environmental damage globally by providing fast detection, quicker emergency response, and long-term predictive AI trained on real-world data.
